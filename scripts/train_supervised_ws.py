"""
Segmentation Model: Train final segmentation model using pseudo masks. Using LR-ASPP MobileNetV3-Large architecture (lightweight, efficient)
Can be purely on pseudo masks or a combination of psuedo masks and ground truth masks (10% - 40%)
"""
