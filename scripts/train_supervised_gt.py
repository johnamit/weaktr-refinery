"""
Fully Supervised Baseline: Train a segmentation model using 100% ground truth masks to establish an upperbound baseline to compare to the weakly-supervised approaches
- How much performance do we lose by using weak supervision instead of full supervision?
"""
